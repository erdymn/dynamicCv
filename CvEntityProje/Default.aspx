...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="web/images/profile.jpg" alt="news image" class="img-fluid navimg">
            <h1 class="top_hd mt-2 text-white">Erdi Yaman</h1>
    ...
    <div class="main">
            ...
            <div class="container">
                <div class="mx-auto text-center">
                   <%-- <h3>ERDİ YAMAN
                    ...
                    <h3 class="banp mx-auto mt-3 text-uppercase">
        ...
        <section class="wedo" id="contact">
            ...
            <div class="cpy-right text-center">
                <p>
                     Design by
					<a href="https://github.com/erdymn">Erdi Yaman.</a>
                </p>
            </div>
        </section>
        <!-- //contact -->
